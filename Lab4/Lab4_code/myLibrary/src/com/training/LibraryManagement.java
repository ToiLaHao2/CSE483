...
public class LibraryManagement extends JFrame {
	...
	public LibraryManagement() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					Database.addBook(booktitleField.getText(),
							...
							isbnField.getText(),
							availableField.isEnabled() ? true : false);
		...
		checkoutPanel.add(new JLabel("Checkout Date: yyyy-mm-dd"));
		checkoutPanel.add(checkoutDateField);
		checkoutPanel.add(new JLabel("Due Date: yyyy-mm-dd"));
		checkoutPanel.add(dueDateField);
		checkoutPanel.add(new JLabel("Return Date: yyyy-mm-dd"));
