...
public class CourseManagerB {
    private static final CourseManagerB instance = new CourseManagerB();
    private List<Course> courses;
    private List<Student> students;
    private HashMap<String, Registration> registrations;

    private CourseManagerB() {
        this.courses = new ArrayList<>();
        this.students = new ArrayList<>();
        this.registrations = new HashMap<>();
    }

    public static CourseManagerB getInstance() {
        return instance;
    }
